...
function Desc(props) {
  ...
  if (props.subtitle == "alternate") {
    subtitle = <p id = "fileSubTitle" style = {{fontSize: "14px", fontFamily: "RalewayRegIta",color: "#0000EE", marginTop: "-17px", textAlign: "center"}} ><a target="_blank"  href = "Edward_Ren_Resume.pdf">Resume</a></p>
  } else {
