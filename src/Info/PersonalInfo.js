...
var Info = [
  ...
  [
    ...
    ["WATonomous", "", "Subteam Lead, Full Stack Web Developer: <a href = 'www.watonomous.ca' > Website</a> | <a href = 'https://github.com/EdwaRen/webtonomous' >Git</a>", "Redesigned website using React and Bootstrap for the University of Waterloo’s autonomous car team <br /> <br />Built back end signup page with node and Express to save applications into a MongoDB database.<br /> <br />Maintained and updated legacy website using LeanWebTools while redesigning current webpage", "September 2017 - Present", "Waterloo", ""],
    
    [ "Team Goals","", "Founder, Overall Developer: <a href = 'https://github.com/EdwaRen/Team_Goals'>Git</a>", "Website coded with React and supported by Firebase to create a real-time database that organizes goals for a team.<br ><br >Employed Javascript ES6 with Redux to support a high degree of user interactivity with website.", "Spring 2017 - Summer 2017", "Ottawa-Colonel By", ""],
